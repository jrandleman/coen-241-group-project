...
aws lambda add-permission --function-name tester --statement-id $statement --action 'lambda:InvokeFunction' --principal events.amazonaws.com --source-arn arn:aws:events:us-west-1:392970261554:rule/$rule
...
echo '[{"Id": "1","Arn": "arn:aws:lambda:us-west-1:392970261554:function:tester"}]' > targets.json
