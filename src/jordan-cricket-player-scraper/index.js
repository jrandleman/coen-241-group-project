...
async function getPlayerData(live_player_url) {
    ...
    try {
        ...
        var batsman = $('span.bat-bowl-miniscore').eq(0).text().replace('*','').trim();
        ...
        var batsmantwo = $('td[class="cbz-grid-table-fix "]').eq(10).text().replace('*','').trim();
        ...
        var bowler = $('span.bat-bowl-miniscore').eq(2).text().replace('*','').trim();
        ...
        var bowlertwo =  $('span.bat-bowl-miniscore').eq(3).text().replace('*','').trim();
